...
<div class="main-content">
			...
			<div class="row">						
				<div class="widget-box">
					<div class="widget-header">
						<h4 class="widget-title">Cập Nhật Tòa Nhà</h4>
					...
					<form:form method="POST" action="" id="buildingInfo" modelAttribute="buildingModelAttribute">
						    ...
						    <div class="row">
						        <div class="col-xs-12 col-sm-12" style="display: inline;">
						            <form:button id="editBuildingInfo"  class="btn btn-sm btn-success">
						                Sửa Tòa Nhà
	...
	$('#editBuildingInfo').click(				
			...
			*/
			...
			var data = {}; //object
			data.id = ${buildingModelAttribute.id };
			...
			<c:url var="API_ADMIN_BUILDING_UPDATE" value="/api/admin/building/update" />
			$.ajax(
			{
				type:"PUT",
				url:"${API_ADMIN_BUILDING_UPDATE }",
